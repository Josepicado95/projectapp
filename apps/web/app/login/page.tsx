...
function JustRegisteredMessage() {
  ...
  return (
    <div style={{
      background: "rgba(126,154,134,.15)", border: "1px solid rgba(126,154,134,.4)",
      borderRadius: 10, padding: "10px 14px", marginBottom: 18,
      fontSize: 13.5, color: "#A8D4B4",
    }}>
        ...
        <div style={{
          ...
          <form action={formAction}>
            ...
            <div style={{ textAlign: "center", fontSize: 14, color: "#7A8FA0" }}>
              ¿No tienes cuenta?{" "}
              <Link href="/register" style={{ color: "#7EB8D8", fontWeight: 600, marginLeft: 4, textDecoration: "none" }}>
                Créala aquí
              </Link>
            </div>
          </form>
